      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>Categories</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Categories</h1>
          </div>
        </div>
      </div>
    </div>
    		...
    		<div class="row">
    			<div class="col-lg-8">
		          ...
		          <div class="col-md-12 heading-section text-center ftco-animate">
		            <h2 class="mb-1">Asia</h2>
		            <span class="d-block mb-4">5 Articles</span>
