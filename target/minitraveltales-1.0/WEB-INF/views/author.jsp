    		...
    		<div class="row justify-content-center">
    			<div class="col-md-8">
    				<div class="author-wrap d-flex">
    					<div class="img" style="background-image: url(resources/core/images/person_1.jpg);"></div>
    					<div class="text">
    						<h3>Dave Lewis</h3>
    						<span class="d-block">10 Articles</span>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove</p>
    						<p><a href="author-post.html" class="btn btn-primary btn-outline-primary">View Articles</a></p>
    					</div>
    				</div>
    				<div class="author-wrap d-flex">
    					<div class="img" style="background-image: url(resources/core/images/person_2.jpg);"></div>
    					<div class="text">
    						<h3>Han Smith</h3>
    						<span class="d-block">7 Articles</span>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove</p>
    						<p><a href="author-post.html" class="btn btn-primary btn-outline-primary">View Articles</a></p>
    					</div>
    				</div>
    				<div class="author-wrap d-flex">
    					<div class="img" style="background-image: url(resources/core/images/person_3.jpg);"></div>
    					<div class="text">
    						<h3>George Buff</h3>
    						<span class="d-block">10 Articles</span>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove</p>
    				...
    				<div class="author-wrap d-flex">
    					<div class="img" style="background-image: url(resources/core/images/person_4.jpg);"></div>
    					<div class="text">
    						<h3>Nick Henderson</h3>
    						<span class="d-block">10 Articles</span>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove</p>
    						<p><a href="author-post.html" class="btn btn-primary btn-outline-primary">View Articles</a></p>
    					</div>
